...
#_(def test-connection-instance-1 (wrap-async-machine stm1))
#_(def test-connection-instance-2 (wrap-async-machine stm2))

#_(let [end-channel (suck test-connection-instance-1 5)]
